#!/usr/bin/env python3
"""Generate VANILA(rev) vs VANILA(nonrev) vs OPENACC comparison diagrams for +R4 models (v3 - ptn_freq fix).
...
results_path = "/Users/u7826985/Projects/Nvidia/results/2026_03_19_complexdata_bugfixes_R_v3"
...
print("\n" + "=" * 100)
print("3-WAY COMPARISON SUMMARY (v3 - ptn_freq fix): VANILA(rev) vs VANILA(nonrev) vs OPENACC for +R4")
print("=" * 100)
...
print("\n--- INTERPRETATION ---")
print("v3 adds `#pragma acc update device(ptn_freq[0:nptn])` in ratefree.cpp M-step.")
print("If ACC vs NONREV diffs dropped to ~0: the ptn_freq sync was the root cause.")
print("If diffs persist: there is another GPU-side divergence in the EM optimization loop.")
